...
3. Person 2 creates a new RStudio Cloud instance using Person 1's github repository.
4. Person 2 adds in github credentials (sorry, not saved across instances!)
